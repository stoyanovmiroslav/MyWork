...
const EditMeeting = ({ match }) => {
    ...
    useEffect(() => {
        meetingService.getById(meetingId).then((data) => setMeeting(data.data[0]));
    }, [meetingId]);
    ...
    const handleSubmit = event => {
        ...
        meetingService.postEdit(meetingId, form.elements.name.value, form.elements.description.value, form.elements.location.value, form.elements.startDate.value,
    ...
    return (
        <Container className='pl-0'>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <h1 className="text-center mt-3">Edit Meeting</h1>
                <Form.Row  >
                    <Col md={{ span: 8, offset: 2 }}>
                        <Form.Group controlId="formGridName">
                            <Form.Label>Name:</Form.Label>
                            <Form.Control name="name" placeholder="Name" defaultValue={meeting.name} required minLength='3' />
                            <Form.Control.Feedback type="invalid">Name should be at the least 3 symbols!</Form.Control.Feedback>
                            <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group controlId="formGridDescription">
                            <Form.Label>Description:</Form.Label>
                            <Form.Control as="textarea" rows="3" name="description" defaultValue={meeting.description} placeholder="Description" required minLength='5' />
                        ...
                        <Form.Group controlId="formGridLocation">
                            ...
                            <Form.Control name="location" placeholder="Location" defaultValue={meeting.location} required minLength='5' />
                        ...
                        <Row>
                            <Col>
                                <Form.Group controlId="formGridStartDate">
                                    ...
                                    <Form.Control name="startDate" type="date" defaultValue={meeting.startDate} required />
                            ...
                            <Col>
                                <Form.Group controlId="formGridEndDate">
                                    ...
                                    <Form.Control name="endDate" type="date" defaultValue={meeting.endDate} required />
                        ...
                        <Row>
                            <Col>
                                <Form.Group controlId="formGridStartTime">
                                    <Form.Control name="startTime" type="time" defaultValue={meeting.startTime} required />
                                    <Form.Control.Feedback type="invalid">Start time is required!</Form.Control.Feedback>
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group controlId="formGridEndTime">
                                    <Form.Control name="endTime" type="time" defaultValue={meeting.endTime} required />
                ...
                <Form.Group className="text-center" id="formGridButton">
                    <Button className="text-center" variant="primary" type="submit">Edit</Button>
                </Form.Group>
            </Form>
        </Container>
    )
